...
open class CardMemberListItemsAdapter(
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            var iv_add_member = holder.itemView.findViewById<CircleImageView>(R.id.iv_add_member)
            var iv_selected_member_image = holder.itemView.findViewById<CircleImageView>(R.id.iv_selected_member_image)
